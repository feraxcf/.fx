...
sudo dnf install "https://github.com/feraxhp/grp/releases/download/$version_name/grp-$nversion-1.x86_64.rpm"
...
sudo dnf install "https://github.com/feraxhp/cim/releases/download/$version_name/cim-$nversion-1.x86_64.rpm"
